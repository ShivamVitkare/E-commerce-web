    ...
    <>
      {cart.length > 0 ? (
        <Fragment>
          ...
          <DialogBody
            divider
            className="flex flex-col justify-center items-start grid grid-cols-2"
          >
            {cart.map((item, index) => {
              return (
                <div key={index}>
          ...
          <DialogFooter className="flex justify-center items-center">
            <Button size="sm" color="green" ripple={true} variant="filled">
              Total Price of All Products:{" "}
              <span className="ml-2 text-[20px]">$ {totalPrice}</span>
            </Button>
          </DialogFooter>
        </Fragment>
      ) : (
        <Fragment>
          ...
          <DialogBody divider className="flex justify-center items-center">
            <div>
