  ...
  return (
    <>
      ...
      <div className="bg-black p-4 w-full flex items-center justify-center mx-auto">
        <p className="text-white font-inter text-base font-bold ">50& OFF</p>
        <p className="text-white font-inter text-base font-bold mx-96">
          Free shipping and returns
        </p>
        <p className="text-white font-inter text-base font-bold ">
